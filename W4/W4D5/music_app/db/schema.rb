...
ActiveRecord::Schema.define(version: 20140425233207) do
  ...
  add_index "users", ["id", "activate_token"], name: "index_users_on_id_and_activate_token", unique: true, using: :btree
