...
(function (root) {
  ...
  Game.prototype.convertSquareNum = function(squareNum) {
    var col = squareNum % 3;
    var row = Math.floor( squareNum / 3 );
    return [row, col];
  }

  Game.prototype.turn = function (squareNum) {
    var game = this;
    var coords = game.convertSquareNum( squareNum );
    // click the square that you want to place your marker in
    // place the marker
    // update the game logic array

    var valid = game.move(coords);
